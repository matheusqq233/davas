        ...
        <div id="page">
            <div id="content">
                <div class="post">
                    ...
                    <button id="btnExcluirUsuario">Excluir Usuário</button>
                    <form action="../controle/usuariocontrole.php?op=deletarusuario" method="post" name="excUsuario" id="excUsuario">
                        <fieldset>
                            <legend>Excluir Usuário</legend>
                            <label>Digite o código:
                                <input type="text" name="idUsuario" id="idUsuario" value="<?php echo isset($_SESSION['usuario']) ? $_SESSION['usuario'][0]->idUsuario : ''; ?>"> *</label> <br>

                            <input type="submit" name="btnExcluir" id="btnExcluirUsuario" value="Excluir">
                            <input type="reset" name="btnLimpar" id="btnLimparUsuario" value="Limpar">
                        </fieldset>
                    </form>

                    <h2 class="title">Exclusão de Notícias</h2>
                    <button id="btnExcluirNoticia">Excluir Notícia</button>
                    <form action="../controle/usuariocontrole.php?op=deletarnoticia" method="post" name="excNoticia" id="excNoticia">
                        <fieldset>
                            <legend>Excluir Notícia</legend>
                            <label>Digite o código:
                                <input type="text" name="idNoticia" id="idNoticia" value="<?php echo isset($_SESSION['noticia']) ? $_SESSION['noticia'][0]->idNoticia : ''; ?>"> *</label> <br>

                            <input type="submit" name="btnExcluir" id="btnExcluirNoticia" value="Excluir">
                            <input type="reset" name="btnLimpar" id="btnLimparNoticia" value="Limpar">
                        </fieldset>
                    </form>
                    ...
                    <script>
                        document.addEventListener('DOMContentLoaded', function () {
                            ...
                            document.getElementById('btnExcluirUsuario').addEventListener('click', function () {
                                esconderFormularios();
                                mostrarFormulario('excUsuario');
                            });

                            document.getElementById('btnExcluirNoticia').addEventListener('click', function () {
                                esconderFormularios();
                                mostrarFormulario('excNoticia');
                            });
                        });
                        ...
                        function mostrarFormulario(nomeFormulario) {
